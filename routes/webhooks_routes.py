...
def _handle_push_webhook(platform_config, platform_name, data_getter_func, validation_func=None):
    ...
    Args:
        platform_config: 平台配置字典 (app_configs 或 app_configs)
    ...
    if platform_name == "github":
        ...
        return _execute_push_task(
            {"access_token": access_token, "owner": owner, "repo_name": repo_name, "repo_full_name": repo_full_name,
             ...
             "default_branch": default_branch, "repo_web_url": repo_web_url}, push_process._process_github_push_payload)
    elif platform_name == "gitlab":
...
def github_push_webhook():
    ...
    return _handle_push_webhook(platform_config=app_configs, platform_name="github",
...
def gitlab_push_webhook():
    ...
    return _handle_push_webhook(platform_config=app_configs, platform_name="gitlab",
